...
pub const TT_OK: c_int = 0;
pub const TT_ERR: c_int = -1;
pub const TT_EVENT_PENDING: c_int = 0;
pub const TT_EVENT_COMPLETE: c_int = 1;
pub const TT_EVENT_ERROR: c_int = 2;
...
///
/// # Safety
/// Caller must pass valid pointers. These stubs always return `TT_ERR`.
#[no_mangle]
