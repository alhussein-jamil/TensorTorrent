...
impl Backend for VirtualBackend {
    ...
    fn memory_report(&self) -> sc_backend_api::BackendMemoryReport {
        sc_backend_api::BackendMemoryReport {
    ...
    fn health(&self) -> sc_backend_api::BackendHealth {
        sc_backend_api::BackendHealth {
