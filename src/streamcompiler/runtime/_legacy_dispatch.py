...
These helpers exist so :mod:`streamcompiler.testing.legacy_runtime` and unit
    ...
    def _body() -> Any:
        ...
        try:
            ...
            raise RuntimePlanError(
                f"Transfer {inst.name}: required source copy missing/stale tensor={tensor_id!r} source={src_resource!r}"
            ) from exc
