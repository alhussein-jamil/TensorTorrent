...
from tensortorrent.errors import DiskSpaceError, MemoryCapacityError, UnsupportedFeatureError
...
def _ensure_pack(
    ...
    *,
    ...
    from tensortorrent.storage.pack import resolve_pack_path
    ...
    # Preflight disk check before writing the pack
    needed = program.total_state_bytes() or 1
    try:
        ...
        pass  # Cannot query disk; proceed and let the OS signal the error
